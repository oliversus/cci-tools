...
#./paperFigures.py ${delLatLon} ${delLatLon} True 07222058 True False True
#./paperFigures.py ${delLatLon} ${delLatLon} True 07221915 True False True
#./paperFigures.py ${delLatLon} ${delLatLon} True 07270810 True False True
